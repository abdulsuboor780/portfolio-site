...
export const CertificationPage: React.FC<CertificationPageProps> = ({ 
  ...
  return (
    <div className="py-12 sm:py-20 relative space-y-16 overflow-hidden">
      
      {/* Background glow */}
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-full max-w-[700px] h-[500px] bg-emerald-500/5 blur-3xl pointer-events-none -z-10" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="relative rounded-3xl bg-slate-900 border-2 border-emerald-500/40 p-3 sm:p-6 shadow-2xl shadow-emerald-950/50">
              ...
              {!certImgError ? (
                <div className="rounded-2xl overflow-hidden border border-slate-800 flex flex-col bg-slate-950 shadow-2xl">
                  {/* Top Bar Header - Placed safely above certificate image */}
                  <div className="px-3 sm:px-4 py-2 sm:py-2.5 bg-slate-950/95 border-b border-slate-800/80 flex items-center justify-between gap-2 z-10">
                    <div className="flex items-center gap-1.5 text-[10px] sm:text-xs font-bold text-emerald-400">
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2">
                      <span className="text-[9px] sm:text-[10px] font-mono text-slate-400 bg-slate-900 px-1.5 sm:px-2 py-0.5 rounded border border-slate-800">
                        ID: {CERTIFICATION_DETAILS.credentialId}
                      </span>
                      <span className="inline-flex text-[9px] sm:text-[10px] font-bold text-emerald-300 bg-emerald-950/60 px-1.5 sm:px-2 py-0.5 rounded border border-emerald-500/30">
                        Verified
                      </span>
                    </div>
                  </div>

                  {/* Clean un-obstructed certificate document */}
